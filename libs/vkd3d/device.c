        ...
        VkPhysicalDevice physical_device, struct vkd3d_device_queue_info *info)
{
    ...
    for (i = 0; i < VKD3D_QUEUE_FAMILY_COUNT; ++i)
    {
        ...
        /* There doesn't seem to be any real use case for more than one graphics queue. */
        if ((info->vk_properties[i].queueFlags & VK_QUEUE_GRAPHICS_BIT) || VKD3D_FORCE_SINGLE_QUEUE)
