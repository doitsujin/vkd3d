...
#include "shaders/resource/headers/cs_copy_simple.h"
    ...
    test_formats[] =
    {
        { DXGI_FORMAT_NV12, 2, { { r8_data,     DXGI_FORMAT_R8_UNORM,  0x80 },   { rg8_data,    DXGI_FORMAT_R8G8_UNORM,   0x8280     } } },
        { DXGI_FORMAT_P010, 2, { { r10x6_data,  DXGI_FORMAT_R16_UNORM, 0x8080 }, { rg10x6_data, DXGI_FORMAT_R16G16_UNORM, 0x82828080 } } },
        { DXGI_FORMAT_P016, 2, { { r16_data,    DXGI_FORMAT_R16_UNORM, 0x8080 }, { rg16_data,   DXGI_FORMAT_R16G16_UNORM, 0x82828080 } } },
    };
